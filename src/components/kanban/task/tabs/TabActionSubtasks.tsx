      ...
      <div className={`subtask-details list`}>
        {
          task.subTasks.map((subTask: ITodo) => (
            <div className="list-item" key={subTask.uuid}>
              ...
              <button className="button item-remove has-height-auto is-danger is-small" onClick={() => dispatch(removeSubTask({boardId, taskId, subTask}))}>
        ...
        <form className="is-full-width" onSubmit={handleSubmit}>
          <div className="field is-grouped">
            <div className="control is-expanded">
              <input className={`input is-small ${errorText ? 'is-danger' : ''}`} type="text" placeholder="What do you need to do?" value={todoText} onChange={handleChange} />
              {
