...
function KanbanSettingsBoard({boardId}: Props) {
    ...
    <div key={boardId} className="list-item">
      ...
      <div className="actions">
        <div className="buttons">
          ...
          <button type="button" className="button is-link is-light is-small" disabled={isBoardFirst}>
          ...
          <button type="button" className="button is-link is-light is-small" disabled={isBoardLast}>
