      ...
      <div className="card-content">
        <nav className="pagination is-centered" role="navigation" aria-label="pagination">
          ...
          <ul className="pagination-list">
            ...
            <li><button className="pagination-link" aria-label="Goto page 5">5</button></li>
            <li><button className="pagination-link is-current" aria-label="Page 6" aria-current="page">6</button></li>
            <li><button className="pagination-link" aria-label="Goto page 7">7</button></li>
            <li><span className="pagination-ellipsis">&hellip;</span></li>
            <li><button className="pagination-link" aria-label="Goto page 15">15</button></li>
          </ul>
        </nav>
